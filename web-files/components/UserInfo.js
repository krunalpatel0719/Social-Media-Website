...
import { getStorage, ref, getDownloadURL, deleteObject, uploadBytesResumable, uploadString, UploadTask} from "firebase/storage";
...
function AccountInfo({ posts }) {
  ...
  const addImageToProfile = (e)=>{
    ...
    reader.onload = (readerEvent) => {
        ...
        const uploadTask = uploadString(storageRef, readerEvent.target.result, 'data_url');
        ...
        >
          <div className="relative w-32 h-32">
            {imageToProfile ? (
                ...
                <img className="rounded-full object-contain h-28 w-28" src={imageToProfile}/>
            ...
            <button onClick={() => filepickerRef.current.click()}>
              <PencilIcon  
               className={`${imageToProfile ? " mt-2" : "ml-2 mt-2"} absolute top-20 left-20  bg-blue-600 rounded-full p-1 text-white h-7 z-10 hover:bg-blue-500 `}></PencilIcon>
            </button>
            <input ref={filepickerRef} onChange={addImageToProfile} type="file" hidden></input>
          </div>
          ...
          <div className="w-full">
            ...
            <div className="pl-10 py-3 flex flex-col  ">
              ...
              <select onChange={handleGenderChange}  value = {localGender}  name="gender" className=" font-medium pr-4 pl-1 text-md  py-1 rounded-lg  
                              bg-white border-2 border-gray-300 w-52 focus:border-blue-600 focus:outline-none">
         ...
         <ClientOnlyPortal selector="#deleteAccount-portal">
            <div  className="flex h-screen m-auto">
              ...
              <div className="">
                ...
                <p className ='pb-5'> Do you want to delete your account? </p>
