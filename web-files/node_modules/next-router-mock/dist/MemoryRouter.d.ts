...
declare type SupportedEventTypes = "routeChangeStart" | "routeChangeComplete" | "NEXT_ROUTER_MOCK:push" | "NEXT_ROUTER_MOCK:replace";
/**
...
export declare abstract class BaseRouter implements NextRouter {
    ...
    isFallback: boolean;
    isPreview: boolean;
    pathParser: ((url: UrlObject) => UrlObject) | undefined;
    ...
    events: MittEmitter<SupportedEventTypes | RouterEvent>;
